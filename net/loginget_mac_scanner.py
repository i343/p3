...
def scan_for_mac():
    ...
    for x in nm.all_hosts():
        if isDebug: print( nm[x]['addresses'], "nm_x_addresses", x, count+1)
    ...
    if isDebug: print("nm.all_hosts()", nm.all_hosts())
    if isDebug: print(choices, "choices")
    if isDebug: print(macs, "macs")
